            ...
            <div id="topo">
                ...
                <div>
                    ...
                    <div id="meio">
                        ...
                        <blockquote> 
                            <blockquote>
                                <h1><strong>.<span class="style1">: Locações Realizadas :.</span></strong></h1>
                            </blockquote>
                        </blockquote>
...
alert('Nenhum Registro Encontado')
                    ...
                    %>--%>
                        <blockquote> 
                            <blockquote>
                                <p><a class="cad" href="cadastrolocacao.jsp" target="_self" class="style1">Adicionar Nova Locação</a> </br>
